...
SELECT * FROM dbo.MsgQueue msg WHERE msg.MsgInTs BETWEEN '05/28/2024' AND '05/29/2024'


/*

DELETE msg FROM dbo.MsgQueue msg WHERE msg.MsgInTs BETWEEN '05/28/2024' AND '05/29/2024'
